...
local rconsolename = rconsolename or rconsoletitle
local exploitcheck =
	is_sirhurt_closure and "Sirhurt" or pebc_execute and "ProtoSmasher" or syn and "Synapse X" or
	secure_load and "Sentinel" or
	KRNL_LOADED and "Krnl" or
	SONA_LOADED and "Sona" or
	identifyexecutor and "Fluxus" or
	"Unknow Exploit"
...
if key ~= oldkey then
	...
	MainFrame.Position = UDim2.new(0.387262076, 0, 0.36166361, 0)
	MainFrame.Size = UDim2.new(0.22518304, 0, 0.273598522, 0)
	...
	Title.Position = UDim2.new(0, 0, 0.0462657027, 0)
	Title.Size = UDim2.new(1, 0, 0.152875081, 0)
	...
	UIGradient.Color = ColorSequence.new({ColorSequenceKeypoint.new(0,Color3.new(0,0,1),0),ColorSequenceKeypoint.new(1,Color3.new(1,0,0),0)})
	UIGradient.Parent = UIStroke

	KeyBox.BackgroundColor3 = Color3.new(0.14902, 0.14902, 0.14902)
	...
	KeyBox.Position = UDim2.new(0.0487646237, 0, 0.370125622, 0)
	KeyBox.Size = UDim2.new(0.899999976, 0, 0.25948444, 0)
	KeyBox.Text = [[]]
	...
	UICorner_1.Parent = KeyBox

	Check.BackgroundColor3 = Color3.new(0.666667, 0.666667, 1)
	Check.BorderColor3 = Color3.new(0, 0, 0)
	Check.BorderSizePixel = 0
	Check.Font = Enum.Font.GothamMedium
	Check.Name = [[Check]]
	Check.Parent = MainFrame
	Check.Position = UDim2.new(0.0487646237, 0, 0.713813663, 0)
	Check.Size = UDim2.new(0.417815268, 0, 0.200000003, 0)
	Check.Text = [[CHECK]]
	Check.TextColor3 = Color3.new(0.411765, 0.411765, 0.615686)
	...
	CopyLink.BackgroundColor3 = Color3.new(0.666667, 1, 1)
	CopyLink.BorderColor3 = Color3.new(0, 0, 0)
	CopyLink.BorderSizePixel = 0
	CopyLink.Font = Enum.Font.GothamMedium
	CopyLink.Name = [[CopyLink]]
	CopyLink.Parent = MainFrame
	CopyLink.Position = UDim2.new(0.529908895, 0, 0.713813663, 0)
	CopyLink.Size = UDim2.new(0.417815268, 0, 0.200000003, 0)
	CopyLink.Text = [[COPY LINK]]
	CopyLink.TextColor3 = Color3.new(0.356863, 0.533333, 0.533333)
	CopyLink.TextScaled = true
	CopyLink.TextSize = 14
	CopyLink.TextWrapped = true

	UICorner_3.Parent = CopyLink

	Check.MouseButton1Click:Connect(function()
		local key,reason = getkey()
		if not key then
			warn("Error key system: ".. reason)
			Succes = true
			return
		end
		if KeyBox.Text == key and not Succes then
			Check.Text = "CORRECT!"
	...
	repeat
		task.wait()
	until Succes == true or Cancel == true
	if Cancel then
		_G.UsingHub = false
		return
	end
